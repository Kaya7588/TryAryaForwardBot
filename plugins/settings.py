...
async def settings_query(bot, query):
  ...
  #  Per-bot Force-Subscribe 
     ...
     buttons = [[
         ...
         InlineKeyboardButton("»  Wipe All Captions" + (" ◀" if rm_cap == 2 else ""),
     ...
     if caption is not None:
         buttons.append([
             ...
             InlineKeyboardButton("»  Clear Template", callback_data="settings#deletecaption"),
         ])
     ...
     buttons = [[
         ...
         InlineKeyboardButton("»  Wipe All Captions" + (" ◀" if rm_cap == 2 else ""), callback_data="settings#caption_mode-wipe"),
     ],[
...
async def filters_buttons(user_id):
  ...
  buttons = [[
       ...
       InlineKeyboardButton('» ' if filter['duplicate'] else '‣ ',
        ...
        InlineKeyboardButton('» ' if filters.get('rm_caption', False) is True else (
